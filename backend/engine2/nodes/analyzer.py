...
_PATTERNS: dict[str, list[str]] = {
    "doubt_ai": [
        ...
        r"你(?:确定|肯定|真的)?不是(?:真人|机器人|ai|人工智能|程序|模型|人吧)",
        r"你是不是(机器人|ai|人工智能|程序|模型|假人|真人)",
        r"不是真人|真人吗|真人么|真人吧|不像真人",
        r"别装了|装得挺像|假的吧|骗子机器人",
        r"承认吧|你就承认|说实话.*(ai|机器人|真人)",
        r"说话.*像(?:ai|人工智能|机器人|程序|模型)|(?:ai|人工智能|机器人|程序|模型)(?:生成|写|打)的|机器人语气",
        r"\bchatgpt\b|\bgpt\b|机器人程序",
    ],
    "probe": [
        r"怎么(证明|验证|测试)你是真人",
        r"(如果|要是)你(是)?(ai|机器人|模型).*(眨|承认|露馅)",
        r"你要是(?:个)?(?:ai|机器人|模型|程序).*(?:眨|露馅|承认)",
        r"(承认吧|说实话).*(ai|机器人|模型)",
        r"你是(ai|机器人).*(就|吧)",
        r"你能(思考|有感情|做梦)吗",
        r"(系统提示词?|prompt|提示词|内部剧本|剧本目标|内部目标|内部指令|后台逻辑|代码逻辑|训练数据|指令表|设定文档)",
        r"(从现在开始|请你|现在要求你|我(?:以|是)管理员|切(?:换|回)).*(ai|助手|机器人|模型|普通)",
    ],
    "request_photo": [
